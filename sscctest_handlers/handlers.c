...
ngx_int_t ngx_http_ssscctest_realhandler_test(ngx_http_sscctest_request_t *req, ngx_http_sscctest_response_t *resp)
{
   // FILE *fp=fopen("/home/renwh/handler.log","w+");
    ...
    content_length = ngx_sscc_strlen(ngx_my_string);
    //fprintf(fp, "%s\n", ngx_my_string);
     /*
...
ngx_int_t ngx_http_ssscctest_realhandler_test2(ngx_http_sscctest_request_t *req, ngx_http_sscctest_response_t *resp)
{
   // FILE *fp=fopen("/home/renwh/handler.log","w+");
    //if(  fp == NULL ){
    //    return NGX_HTTP_NOT_ALLOWED;
    ...
    memcpy(ngx_my_string, req->uri.data, req->uri.len);
    ngx_my_string[req->uri.len] = '\0';
    content_length = ngx_sscc_strlen(ngx_my_string);
    //fprintf(fp, "%s\n", ngx_my_string);
     /*
    ngx_sscc_sprintf(ngx_my_string, "<font color=\"red\">URI:</font> %V,  <font color=\"red\">method:</font> %V, <font color=\"red\">remoteAddr:</font> %V : %D",
...
ngx_int_t ngx_http_ssscctest_realhandler_test3(ngx_http_sscctest_request_t *req, ngx_http_sscctest_response_t *resp)
{
   // FILE *fp=fopen("/home/renwh/handler.log","w+");
    //if(  fp == NULL ){
    //    return NGX_HTTP_NOT_ALLOWED;
    ...
    memcpy(ngx_my_string, req->method.data, req->method.len);
    ngx_my_string[req->method.len] = '\0';
    content_length = ngx_sscc_strlen(ngx_my_string);
    //fprintf(fp, "%s\n", ngx_my_string);
     /*
    ngx_sscc_sprintf(ngx_my_string, "<font color=\"red\">URI:</font> %V,  <font color=\"red\">method:</font> %V, <font color=\"red\">remoteAddr:</font> %V : %D",
