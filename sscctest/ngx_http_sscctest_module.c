...
static int ngx_sscctest_visited_times = 0;
...
static ngx_command_t ngx_http_sscctest_commands[]={
	{
        ...
        */
        ...
        offsetof(ngx_http_sscctest_loc_conf_t, teststr),
        NULL
	},
	{
		...
		*/
		...
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_sscctest_loc_conf_t,testflag),
		NULL
	},
	{
		ngx_string("printnum"),
		...
		*/
		...
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_sscctest_loc_conf_t,testnum),
		NULL
	},
	{
		...
		*/
		...
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(ngx_http_sscctest_loc_conf_t,testsize),
		NULL
	},
	ngx_null_command
};
...
static ngx_http_module_t ngx_http_sscctest_module_ctx = {
        ...
        ngx_http_sscctest_init,           /* postconfiguration */
...
static ngx_int_t ngx_http_sscctest_init(ngx_conf_t *cf)
{
	...
	cmcf = ngx_http_conf_get_module_main_conf(cf, ngx_http_core_module); //取得core_module的cf
        ...
        *h = ngx_http_sscctest_handler; //将函数指针指向handler函数
